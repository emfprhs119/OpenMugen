...
void CEngine::InitEngine(CMemManager *m,CVideoSystem *v,CGameTimer *t)
{
    ...
    player1.SetGroundValue(200);
    player2.SetGroundValue(200);
    
    //this values also should read out of the stage def
    player1.SetPos(90,200);
    player2.SetPos(230,200);
	player1.SetOther(&player2);
	player2.SetOther(&player1);
    
    player1.LoadPlayer("green-kofa");
    player2.LoadPlayer("green-kofa");
